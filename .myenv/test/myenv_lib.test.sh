...
STR_BLANK_TAB="	"
STR_BLANK_SPACE="  "
STR_EN_CHAR="test string 1, AAAA."
...
test_func_shrink_dup_lines() {
	...
	test_verify_str_single_occurrence "${result}" "${STR_EN_CHAR}"
...
test_func_shrink_blank_lines() {
	...
	test_verify_str_contains "${result}" "${STR_EN_CHAR}"
...
test_func_is_str_blank() {
	func_is_str_blank "${STR_EN_CHAR}";		test_verify_rcode_failure
...
test_func_del_blank_lines() {
	...
	test_verify_file_contains "${out_file}" "${STR_EN_CHAR}"
