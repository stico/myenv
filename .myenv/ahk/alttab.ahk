...
Gui_Window_Group_Delete:
  ...
  IniDelete, alttab.ini, Custom_Groups, %A_ThisMenuItem%
  IniDelete, alttab.ini, Group_Hotkey, %A_ThisMenuItem%_Group_Hotkey
  Gosub, Alt_Esc_Check_Alt_State ; hides alt-tab gui - shows again if alt still pressed
Return
...
Load_Settings_From_Ini:
  ; Hotkeys
    IniRead, Alt_Hotkey, alttab.ini, Hotkeys, Alt_Hotkey, !
    IniRead, Tab_Hotkey, alttab.ini, Hotkeys, Tab_Hotkey, Tab
    IniRead, Shift_Tab_Hotkey, alttab.ini, Hotkeys, Shift_Tab_Hotkey, +Tab
    IniRead, Esc_Hotkey, alttab.ini, Hotkeys, Esc_Hotkey, Esc
    IniRead, Single_Key_Show_Alt_Tab, alttab.ini, Hotkeys, Single_Key_Show_Alt_Tab, %Blank%
      If Single_Key_Show_Alt_Tab =ERROR ; set to blank value
        Single_Key_Show_Alt_Tab =
    IniRead, Single_Key_Hide_Alt_Tab, alttab.ini, Hotkeys, Single_Key_Hide_Alt_Tab, Enter

  ; Sort_Order
    IniRead, Sort_Order_Column, alttab.ini, Sort_Order, Sort_Order_Column, 2 ; initial column to sort (2 is a hidden column)
    IniRead, Sort_Order_Direction, alttab.ini, Sort_Order, Sort_Order_Direction, Sort ; initial sort direction

  ; Custom_Groups + Group_Hotkey - remember lists of windows
    IniRead, Custom_Group_List, alttab.ini, Custom_Groups, Custom_Group_List,%Blank%
      If Custom_Group_List =ERROR ; set to blank value
        Custom_Group_List =
    IniRead, Exclude_Not_In_List, alttab.ini, Custom_Groups, Exclude_Not_In_List,%Blank%
        If Exclude_Not_In_List =ERROR ; set to blank value
          Exclude_Not_In_List =
    IniRead, Custom_Group_Active, alttab.ini, Custom_Groups, Custom_Group_Active,%Blank%
        If Custom_Group_Active =ERROR ; set to blank value
          Custom_Group_Active =
    Loop, Parse, Custom_Group_List,|
      {
      IniRead, %A_LoopField%, alttab.ini, Custom_Groups, %A_LoopField%,%Blank%
        If %A_LoopField% =ERROR ; set to blank value
          %A_LoopField% =
      IniRead, %A_LoopField%_Group_Hotkey, alttab.ini, Group_Hotkey, %A_LoopField%_Group_Hotkey,%Blank%
...
Save_Settings_To_Ini:
  ...
  ; Hotkeys
    IniWrite, %Alt_Hotkey%, alttab.ini, Hotkeys, Alt_Hotkey
    IniWrite, %Tab_Hotkey%, alttab.ini, Hotkeys, Tab_Hotkey
    IniWrite, %Shift_Tab_Hotkey%, alttab.ini, Hotkeys, Shift_Tab_Hotkey
    IniWrite, %Esc_Hotkey%, alttab.ini, Hotkeys, Esc_Hotkey
    IniWrite, %Single_Key_Show_Alt_Tab%, alttab.ini, Hotkeys, Single_Key_Show_Alt_Tab
    IniWrite, %Single_Key_Hide_Alt_Tab%, alttab.ini, Hotkeys, Single_Key_Hide_Alt_Tab
    
  ; Sort_Order
    IniWrite, %Sort_Order_Column%, alttab.ini, Sort_Order, Sort_Order_Column 
    IniWrite, %Sort_Order_Direction%, alttab.ini, Sort_Order, Sort_Order_Direction 

  ; Custom_Groups + Group_Hotkey - remember lists of windows
    IniWrite, %Custom_Group_List%, alttab.ini, Custom_Groups, Custom_Group_List
    IniWrite, %Exclude_Not_In_List%, alttab.ini, Custom_Groups, Exclude_Not_In_List
    IniWrite, %Custom_Group_Active%, alttab.ini, Custom_Groups, Custom_Group_Active
    Loop, Parse, Custom_Group_List,|
        {
        IniWrite, % %A_LoopField%, alttab.ini, Custom_Groups, %A_LoopField%
        IniWrite, % %A_LoopField%_Group_Hotkey, alttab.ini, Group_Hotkey, %A_LoopField%_Group_Hotkey
        }
Return
